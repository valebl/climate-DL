...
LOG_PATH="/leonardo_work/ICT23_ESP_0/vblasone/climate-DL/local_single_temporal/cl_fvg_temporal/"

#--------------------------------------------#
# PATHS (conda env, main, accelerate config) #
#--------------------------------------------#
SOURCE_PATH="/leonardo/home/userexternal/.bashrc"
ENV_PATH="/leonardo_work/ICT23_ESP_0/env/GNNenv"
MAIN_PATH="/leonardo_work/ICT23_ESP_0/vblasone/climate-DL/local_single_temporal/local_single/"
...
OUTPUT_PATH="/leonardo_work/ICT23_ESP_0/vblasone/climate-DL/local_single_temporal//cl_fvg_temporal/"
INPUT_FILE="input_standard.pkl"
IDX_FILE="idx_train_cl.pkl"
LOG_FILE="log.txt"
TARGET_FILE="target_train_cl.pkl"
MASK_TARGET_FILE="mask_train_cl.pkl"
GRAPH_FILE="G_train_temporal.pkl"
