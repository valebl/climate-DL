...
#python predictions_local.py --input_path="/m100_work/ICT23_ESP_C/vblasone/climate-DL/test_data_fvg/" --output_path="/m100_work/ICT23_ESP_C/vblasone/climate-DL/predictions/" --idx_file="idx_test.pkl" --graph_file_test="G_test.pkl" --subgraphs="subgraphs.pkl" --checkpoint_cl="/m100_work/ICT23_ESP_C/vblasone/climate-DL/local_single/cl_test/checkpoint_3.pth" --checkpoint_reg="/m100_work/ICT23_ESP_C/vblasone/climate-DL/local_single/reg_test/checkpoint_19.pth" --input_file="input_standard.pkl" --lat_dim=7 --lon_dim=7 --model_name_cl="Classifier_old_test" --model_name_reg="Regressor_old_test" --output_file="G_predictions_2016_test_new.pkl" --log_file="log.txt"
