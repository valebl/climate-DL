...
#SBATCH -o /leonardo_work/ICT23_ESP_0/vblasone/climate-DL/predictions/test_leonardo/run.out
#SBATCH -e /leonardo_work/ICT23_ESP_0/vblasone/climate-DL/predictions/test_leonardo/run.err
