...
#SBATCH --job-name=ita-2
## SBATCH --mail-type=FAIL,END
## SBATCH --mail-user=vblasone@ictp.it
#SBATCH -o /leonardo_work/ICT23_ESP_0/vblasone/climate-DL/predictions/italy_2/run.out
#SBATCH -e /leonardo_work/ICT23_ESP_0/vblasone/climate-DL/predictions/italy_2/run.err
