...
#SBATCH -o /m100_work/ICT23_ESP_C/vblasone/climate-DL/preprocessing/prep-graph-fvg.out
#SBATCH -e /m100_work/ICT23_ESP_C/vblasone/climate-DL/preprocessing/prep-graph-fvg.err
...
## fvg
python3 preprocessing_graphs_and_targets.py --input_path='/m100_work/ICT23_ESP_C/SHARED/' --output_path='/m100_work/ICT23_ESP_C/vblasone/climate-DL/data_fvg_preprocessed/' --log_file='log.txt' --lon_min=12.75 --lon_max=14.00 --lat_min=45.50 --lat_max=46.75 --interval=0.25 --time_dim=140256 --suffix="" --make_plots
