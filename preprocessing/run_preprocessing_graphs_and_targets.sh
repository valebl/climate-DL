...
## fvg
python3 preprocessing_graphs_and_targets.py --input_path='/m100_work/ICT23_ESP_C/SHARED/' --output_path='/m100_work/ICT23_ESP_C/SHARED/preprocessed/fvg/' --log_file='log.txt' --lon_min=12.75 --lon_max=14.00 --lat_min=45.50 --lat_max=46.75 --interval=0.25 --time_dim=140256 --suffix="" --make_plots --precomputed_stats_file='TOPO/z_stats_italy.pkl' --use_precomputed_stats

## north
#python3 preprocessing_graphs_and_targets.py --input_path='/m100_work/ICT23_ESP_C/SHARED/' --output_path='/m100_work/ICT23_ESP_C/SHARED/preprocessed/north/' --log_file='log.txt' --lon_min=6.75 --lon_max=14.00 --lat_min=43.75 --lat_max=47.00 --interval=0.25 --time_dim=140256 --suffix="" --make_plots  --precomputed_stats_file='z_stats_italy.pkl' --use_precomputed_stats
