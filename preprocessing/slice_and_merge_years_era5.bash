...
for v in 'v' 'z' ; do #'q' 't' 'u' ; do #'v' 'z' ; do
    files=$(ls ${v}_*.nc)
    for file in $files ; do
        cdo sellonlatbox,12.0,14.75,44.75,47.5 /m100_work/ICT23_ESP_C/vblasone/ERA5/${file} /m100_work/ICT23_ESP_C/vblasone/NORTH_ITALY/fvg/${file}_sliced.nc
    done
done
